...
assetsRouter.post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
      if (mspId === 'Org1MSP') {
        console.log('easwar');
        console.log(typeof req.body.rid);
        console.log(typeof req.body.availability);
        console.log(typeof req.body.usage);
        ...
        console.log('rohit');
        console.log(typeof req.body.id);
        console.log(typeof req.body.speed);
        console.log(typeof req.body.acceleration);
        console.log(typeof req.body.decelaration);
        console.log(typeof req.body.steering);
        jobId = await addSubmitTransactionJob(
          submitQueue,
          mspId,
          'CreateAsset',
        ...
        console.log(typeof req.body.id);
        console.log(typeof req.body.temperature);
        console.log(typeof req.body.fuel);
        console.log(typeof req.body.coolant);
        console.log(typeof req.body.oilpressure);
        jobId = await addSubmitTransactionJob(
          submitQueue,
          mspId,
          'CreateAsset',
          ...
          req.body.fuel,
          req.body.coolant,
          req.body.oilpressure
        );
      } else {
        console.log('farzan');
        console.log(typeof req.body.id);
        console.log(typeof req.body.xco);
        console.log(typeof req.body.yco);
        console.log(typeof req.body.speed);
        jobId = await addSubmitTransactionJob(
          submitQueue,
          mspId,
      ...
      logger.error({ err }, 'Error processing create asset request for asset');
